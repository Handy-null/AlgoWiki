...
urlpatterns = [
    ...
    path("auth/password-reset-code/", PasswordResetCodeView.as_view(), name="auth-password-reset-code"),
    ...
    path("me/change-password-code/", ChangePasswordCodeView.as_view(), name="me-change-password-code"),
